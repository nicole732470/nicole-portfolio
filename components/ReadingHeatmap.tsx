import { buildActivityHeatmapGrid, readingActivity } from "@/lib/movie-activity";
...
export function ReadingHeatmap() {
  const { grid, cols, monthLabels } = buildActivityHeatmapGrid(readingActivity, 28);

  return (
    <div className="mt-5 w-full">
      <p className="mb-2 text-xs font-medium text-tea">Reading rhythm</p>
              ...
              {row.map((cell) => (
                <div
                  ...
                  title={
                    cell.date
                      ? cell.count
                        ? `${cell.date}: ${cell.count} reading day${cell.count > 1 ? "s" : ""}`
                        : cell.date
                      : undefined
                  }
